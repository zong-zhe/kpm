...
func (g *Git) Hash() (string, error) {
	return utils.GenerateHash(g.Url)
}

func (o *Oci) Hash() (string, error) {
	return utils.GenerateHash(filepath.Join(o.Reg, filepath.Dir(o.Repo)))
}

func (l *Local) Hash() (string, error) {
	return utils.GenerateHash(l.Path)
}

func (r *Registry) Hash() (string, error) {
	return utils.GenerateHash(filepath.Join(r.Reg, filepath.Dir(r.Repo)))
}
